...
class Library {
  ...
  // write a method called deletebook; takes in isbn as parameter and
  // updates this._books to remove the book with the matching isbn
  deleteBook(isbn) {
    this._books = this._books.filter(book => book.isbn !== isbn)
  }
}

const library = new Library("My libary");
